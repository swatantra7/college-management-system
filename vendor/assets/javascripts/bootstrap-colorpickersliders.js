  ...
  $.fn.ColorPickerSliders = function(options) {
    ...
    return this.each(function() {
      ...
      function _getControllerHtml() {
        ...
        if (settings.swatches) {
          color_picker_html += '<div class="cp-swatches clearfix"><button type="button" class="add btn btn-default" title="' + settings.titleswatchesadd + '"><span class="fa fa-floppy-o"></span></button><button type="button" class="remove btn btn-default" title="' + settings.titleswatchesremove + '"><span class="fa fa-trash-o"></span></button><button type="button" class="reset btn btn-default" title="' + settings.titleswatchesreset + '"><span class="fa fa-refresh"></span></button><ul></ul></div>';
        }
